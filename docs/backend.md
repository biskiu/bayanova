...
No application API endpoints, domain models, authentication flow, authorization policies, payment integration, file-storage workflow, or frontend API client are currently established in the repository.
...
- Treat member, dependent, claim, payment, document, notification, support-ticket, and audit data as sensitive. Define access rules explicitly.
